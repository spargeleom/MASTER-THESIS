...
\begin{figure}[t]
    ...
    \centering
        \includegraphics[keepaspectratio, width = \minifigwidth]{contents/ForceControl/figure/PIDcontroller-crop.pdf}
%        \input{contents/ForceControl/figure/TikZ/PID.tex}
    ...
    \begin{minipage}{\minipageratio\hsize}
    \centering
        \includegraphics[keepaspectratio, width = \minifigwidth]{contents/ForceControl/figure/I-PDcontroller-crop.pdf}
