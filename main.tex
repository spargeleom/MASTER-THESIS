...
\def\Ah{A_\mathrm{h}}
\def\Ar{A_\mathrm{r}}
\def\GinTofmsr{G_{\mathrm{in}2\fmsr}}
\def\GinTofthr{G_{\mathrm{in}2\fthr}}
...
% \input{contents/基礎方程式/基礎方程式.tex}
\input{contents/システム同定/システム同定.tex}
% \input{contents/力制御/力制御.tex}
